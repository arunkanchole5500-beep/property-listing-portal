...
Revises: 
Create Date: 2026-01-06 14:32:59.062852
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_type', sa.Enum('ADMIN', 'STAFF', name='user_type_enum'), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('service_project_id', sa.Integer(), nullable=True),
    sa.Column('url', sa.String(length=500), nullable=False),
